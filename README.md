...
- [ ] Explain what a token is used for.
  ...
  - Tokens are used to authenticate and authorize user access to protected content in the web application

- [ ] What steps can you take in your web apps to keep your data secure?

  - Using a private route with client-side authorization to enable a login component is a safe way to keep your data secure.
  
- [ ] Describe how web servers work.

  - A web server stores code for a website. I can either be an entire computer dedicated to this cause or a program that run on such a computer.
